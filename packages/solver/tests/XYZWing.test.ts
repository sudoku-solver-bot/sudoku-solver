...
import { XYZWingCandidateEliminator } from '../src/Eliminators'

const SOLVED = '534678912672195348198342567859761423426853791713924856961537284287419635345286179'

describe('XYZWingCandidateEliminator', () => {
    it('has correct displayName', () => {
        expect(new XYZWingCandidateEliminator().displayName).toBe('XYZ-Wing')
    })

    it('returns false on empty board', () => {
        const board = BoardReader.fromString('.'.repeat(81), Board)
        expect(new XYZWingCandidateEliminator().eliminate(board)).toBe(false)
    })
    ...
    it('does not throw on partial board', () => {
        ...
        new XYZWingCandidateEliminator().eliminate(board)
    ...
    it('handles XYZ-Wing pattern detection', () => {
        const puzzle =
            '...37....' +
            '.1......9' +
            '6........' +
    ...
    it('handles board with many tri-value cells', () => {
        const puzzle =
            '123456789' +
            '456789123' +
            '789123456' +
